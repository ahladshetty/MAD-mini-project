...
import com.example.travelassistant.Adapter.CheckListAdapter;
import com.example.travelassistant.Constants.MyConstants;
import com.example.travelassistant.Data.AppData;
import com.example.travelassistant.Database.RoomDB;
import com.example.travelassistant.Model.Items;
        ...
        if (id == R.id.btnMySelection) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("Are you sure?\n\nAs this will delete the data provide by" +
                            "(Travel Assistant) while installing..")
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("Are you sure?\n\nAs this will delete the data provide by" +
                            "(TravelAssistant) and will delete the custom data" +
