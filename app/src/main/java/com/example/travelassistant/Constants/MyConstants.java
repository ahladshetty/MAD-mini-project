package com.example.travelassistant.Constants;
...
public class MyConstants {
    ...
    public static final String HEALTH_CAMEL_CASE = "Health Kit";
    public static final String TECHNOLOGY_CAMEL_CASE = "Gadgets";
    public static final String FOOD_CAMEL_CASE = "Food Items";
